<?php
/**
 * Database management for HellaZ SiteZ Analyzer.
 *
 * Handles table creation, upgrades, cleanup, optimization, and statistics.
 *
...
class Database {
	...
	/**
	 * Creates or updates all necessary database tables.
	 */
